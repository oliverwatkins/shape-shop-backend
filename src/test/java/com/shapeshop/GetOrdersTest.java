...
//			JSONArray array = (JSONArray)obj;
		...
		String actual2 = "[{\"id\":1,\"company\":{\"id\":1,\"name\":\"alpenhof\"}," +
                "\"creditCardEntity\":{\"id\":1,\"number\":\"xxx-xxx-xxxx-6345\",\"expDate\":\"22/22\",\"name\":\"JJ Binks\",\"type\":\"VISA\"}," +
                "\"addressEntity\":{\"name\":\"Jar Jar Binks\",\"street\":\"Bluw Lane Hwy 12\",\"postcode\":\"41412\",\"telephone\":\"+(09)928423444\",\"email\":\"jj@gmail.com\"}," +
                "\"orderItems\":[" +
                "{\"id\":1,\"product\":{\"id\":14,\"name\":\"hotdog\",\"price\":7.90,\"type\":\"main\",\"imageFilename\":\"na.png\"},\"amount\":2}," +
                "{\"id\":2,\"product\":{\"id\":15,\"name\":\"pizza\",\"price\":7.90,\"type\":\"main\",\"imageFilename\":\"na.png\"},\"amount\":2}]}]";

		//TODO improve this test to look at exact JSON structure


//		assertEquals(actual2, contentAsString);
